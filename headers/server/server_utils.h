...
/**
 * @brief Retrieves the SSL contexts for a specified game.
 * 
 * @param[in] clients_infos Array of client information.
 * @param[in] game_udp_port The UDP port of the game.
 * @param[out] res Array to store the retrieved SSL contexts.
 * @param[in] codereq Code request.
 * @param[in] id_team Team ID.
 * @return int The number of SSL contexts retrieved.
 */
